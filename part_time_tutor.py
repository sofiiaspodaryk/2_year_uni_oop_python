...
class PartTimeTutor(Tutor):
    ...
    def __str__(self):
        return f"PartTimeTutor: {self.name} {self.surname}, Email: {self._email}, Phone: {self._phone_number}, Hired: {self._hire_date}, Subject: {self._subject}, Hours/Week: {self._hours_per_week}"